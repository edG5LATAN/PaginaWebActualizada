...
function Footer() {
  ...
  const enviarCorreo = (valores) => {
    ...
    emailjs
      .send(serviceID, templateID, valores, userID)
      .then(() => {
    ...
    <div className="footer">
      <div className="footer_caja">
        ...
        <div className="footer_redes">
          ...
          <div className="footer_redes_iconos">
            <svg
        ...
        <div className="footer_contacto">
          ...
          <Formik
            ...
            validate={(valores) => {
              ...
              if (!valores.nombre) {
                ...
                errores.nombre =
                  "no puede tener carcateres especiales solo letras";
              }
          ...
          >
            {({ errors }) => (
              <Form className="form">
                <div className="footer_contacto_input">
                ...
                <div className="footer_contacto_input">
                  <label htmlFor="cuerpo">Asunto</label>
                  <Field
                    as="textarea"
                    name="cuerpo"
                    id="cuerpo"
